    ...
    <main className={styles.main}>
      ...
      <div className={styles.grid}>
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <h2>YogaSplat: Generalized 4D Gaussians <span className={styles.toRight}>&gt;</span></h2>
        </a>
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <h2>Data Analysis for DAEBAK Dance Team <span className={styles.toRight}>&gt;</span></h2>
        </a>
